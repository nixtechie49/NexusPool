#ifndef NEXUSPOOL_NETWORK_ENDPOINT_HPP
#define NEXUSPOOL_NETWORK_ENDPOINT_HPP
...
public:
    using Transport_protocol = ::nexuspool::network::Transport_protocol;
    using Internet_protocol = ::nexuspool::network::Internet_protocol;
...
#endif // NEXUSPOOL_NETWORK_ENDPOINT_HPP