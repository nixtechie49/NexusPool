#ifndef NEXUSPOOL_NETWORK_TCP_PROTOCOL_DESCRIPTION_HPP
#define NEXUSPOOL_NETWORK_TCP_PROTOCOL_DESCRIPTION_HPP
...
#endif // NEXUSPOOL_NETWORK_TCP_PROTOCOL_DESCRIPTION_HPP